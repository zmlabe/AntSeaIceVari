"""
Script plots monthly mean surface heat fluxes and sea ice extent in the 
Antarctic
...
sief = np.genfromtxt(directoryoutput + 'SIE/Antarctic_SIE_PAMIP-1.8.txt')
siepd = np.genfromtxt(directoryoutput + 'SIE/Antarctic_SIE_PAMIP-1.1.txt')
siepi = np.genfromtxt(directoryoutput + 'SIE/Antarctic_SIE_PAMIP-1.7.txt')
...
heatsat = np.genfromtxt(directoryoutput + 'Antarctic_RNETA_PD.txt')
heatold = np.genfromtxt(directoryoutput + 'Antarctic_RNETA_PI.txt')
