...
directoryoutput = '/home/zlabe/Documents/Research/AntSeaIceVari/Data/SIE/'
...
print('\n' '----Plotting SIE for Antarctica- %s----' % titletime)
...
###########################################################################
### Read in data
sicf,lat,lon = readSICData('ANT_Fu')
...
###############################################################################
### Save data output
np.savetxt(directoryoutput + 'Antarctic_SIE_PAMIP-1.8.txt',extf)
np.savetxt(directoryoutput + 'Antarctic_SIE_PAMIP-1.1.txt',extpd)
np.savetxt(directoryoutput + 'Antarctic_SIE_PAMIP-1.7.txt',extpi)