# AntSeaIceVari
Here we conduct a series of large ensemble simulations (100 members each) to assess the large-scale atmospheric response to Antarctic sea-ice loss under global warming projections of 2°C. We follow the new PAMIP protocol using the SC-WACCM4 and E3SM atmospheric general circulation models.
